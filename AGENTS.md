...
- `./scripts/dev.sh release` (build artifacts, push branch+tag, publish GitHub release assets)
- `./scripts/dev.sh release --bump[=patch|minor|major|VERSION]` (bump, tag, and publish GitHub
  release assets)
